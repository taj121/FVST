...
\usepackage{xifthen}        % for macros
\usepackage{hyperref}     % lipics does not like this
\usepackage{cleveref}
...
\usepackage{amssymb}
\usepackage{savesym}      % enables latex trickery
\usepackage{enumerate}
\usepackage{logicproof}     % for Natural Deduction proofs
\usepackage{array}
...
\renewcommand{\thesisauthor}{Th\'{e}a Johnson}            %% Your official UT name.
\renewcommand{\thesismonth}{April}                  %% Your month of graduation.
\renewcommand{\thesisyear}{2016}                      %% Your year of graduation.
\renewcommand{\thesistitle}{Formal Verification of Session Types}            %% The title of your thesis; use mixed-case.
\renewcommand{\thesisauthorpreviousdegrees}{}  %% Your previous degrees, abbreviated; separate multiple degrees by commas.
\renewcommand{\thesissupervisor}{Dr. Vasileios Koutavas}      %% Your thesis supervisor; use mixed-case and don't use any titles or degrees.
...
%%
  ...
  \include{evaluation}  
  \include{conclusion} 
\addcontentsline{toc}{chapter}{Code Repository}
  \include{code}
...
\addcontentsline{toc}{chapter}{DVD}
